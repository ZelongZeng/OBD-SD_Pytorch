from metrics import e_recall, nmi, f1, mAP, mAP_c, mAP_1000, mAP_lim, mAP_lim_visualization
...
def select(metricname, opt):
    ...
    if 'e_recall' in metricname:
        ...
        return f1.Metric()
    elif metricname=='mAP_lim_visualization':
        return mAP_lim_visualization.Metric()
